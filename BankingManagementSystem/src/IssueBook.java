...
public class IssueBook extends javax.swing.JPanel implements ActionListener,FocusListener
{
	int i=0;
	int a=0;
	int b=0;
	 ...
	 public void focusLost(FocusEvent arg0) 
		...
		{		
			...
			if(arg0.getSource()==jButton1)
			{
				...
				String publication=jTextField7.getText();
				String category=jTextField8.getText();
				String quantity=jTextField9.getText();
				String biusn=jTextField10.getText();
				...
				try
				{
					...
					while(res.next())
					{
						...
						{
							check=1;
							JOptionPane.showMessageDialog(this,"This Book has already Issued on this ID!","Error",JOptionPane.ERROR_MESSAGE);
							jTextField1.setText("");
							  jTextField2.setText("");
							  jTextField3.setText("");
							  jTextField4.setText("");
				...
				if(check==0)
				{
				String query2="insert into issuebooks values(?,?,?,?,?,?,?,?,?)";
					  try
					  {
					  ...
					  {		
						  ...
						  System.out.println("Remaining:="+quant);
						  if(quant>0)
						  {
						  ...
						  JOptionPane.showMessageDialog(this, "Book has been Issued...", "Success", JOptionPane.INFORMATION_MESSAGE);
						  jTextField1.setText("");
						  jTextField2.setText("");
						  jTextField3.setText("");
						  jTextField4.setText("");
					  ...
					  {
						  JOptionPane.showMessageDialog(this, "Book didn't Issued", "Error", JOptionPane.ERROR_MESSAGE);
						  jTextField1.setText("");
						  jTextField2.setText("");
						  jTextField3.setText("");
						  jTextField4.setText("");
